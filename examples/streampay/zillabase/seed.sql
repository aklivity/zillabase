...
WITH (
    connector='kafka',
    topic='dev.streampay_users',
    properties.bootstrap.server='kafka.zillabase.dev:29092',
    scan.startup.mode='latest',
    scan.startup.timestamp.millis='140000000'
) FORMAT UPSERT ENCODE AVRO (
    schema.registry = 'http://karapace.zillabase.dev:8081'
);
...
WITH (
    connector='kafka',
    topic='dev.streampay_request_payments',
    properties.bootstrap.server='kafka.zillabase.dev:29092',
    primary_key='id'
) FORMAT UPSERT ENCODE AVRO (
    schema.registry = 'http://karapace.zillabase.dev:8081'
